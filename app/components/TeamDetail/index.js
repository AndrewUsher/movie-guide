  ...
  requestTeamInfo = async () => {
    ...
    try {
      ...
      this.setState({
        ...
        known_for_department: data.known_for_department || 'Uninformed department',
            ...
            <View style={styles.containerModal}>
              <ScrollView style={styles.containerScroll}>
                <View style={styles.containerMainText}>
                  <Image source={this.getImageApi(profile_path)} style={styles.photo} width={width * 0.33} />
                ...
                <Text style={[styles.textSmall, styles.textLineHeight, styles.textJustify]}>{biography}</Text>
              </ScrollView>
              <View style={styles.containerRow}>
                <TouchableOpacity activeOpacity={0.5} style={styles.button} onPress={actionClose}>
                  <Text style={styles.buttonText}>Close</Text>
